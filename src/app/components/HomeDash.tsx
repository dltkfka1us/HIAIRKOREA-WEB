  ...
  return (
    <div className="home-dashboard animate-in fade-in duration-300">
      ...
      <section className="home-grid-top">
        ...
        {/* 1. Education Status */}
        <div className="content-card kpi-dashboard-card border border-slate-200/80 shadow-sm rounded-[20px] bg-white overflow-hidden h-[360px] flex flex-col transition hover:shadow-md">
          <div className="card-header-simple p-3.5 px-4 border-b border-gray-100 flex items-center gap-2.5 shrink-0">
            <div className="icon-box bg-transparent w-auto h-auto p-0 flex items-center justify-center">
              <i className="fa-solid fa-graduation-cap text-emerald-500 text-lg"></i>
            </div>
          ...
          <div className="home-card-content loaded p-4 flex-1 flex flex-col justify-between" id="home-edu-content">
            <div className="kpi-mini-row grid grid-cols-4 gap-2 mb-4">
              <div className="kpi-mini-item text-center bg-slate-50 rounded-xl py-2.5">
                <span className="label block text-[11px] font-bold text-slate-500 mb-1">대상</span>
                <span className="value block text-xl font-black text-slate-800">{eduData?.total?.target || 0}<small className="text-xs font-medium ml-0.5">명</small></span>
              </div>
              <div className="kpi-mini-item text-center bg-slate-50 rounded-xl py-2.5">
                <span className="label block text-[11px] font-bold text-slate-500 mb-1">이수</span>
                <span className="value block text-xl font-black text-emerald-500">{eduData?.total?.done || 0}<small className="text-xs font-medium ml-0.5">명</small></span>
              </div>
              <div className="kpi-mini-item text-center bg-slate-50 rounded-xl py-2.5">
                <span className="label block text-[11px] font-bold text-slate-500 mb-1">미이수</span>
                <span className="value block text-xl font-black text-rose-500">{eduData?.total?.undone || 0}<small className="text-xs font-medium ml-0.5">명</small></span>
              </div>
              <div className="kpi-mini-item text-center bg-slate-50 rounded-xl py-2.5">
                <span className="label block text-[11px] font-bold text-slate-500 mb-1">이수율</span>
                <span className="value block text-xl font-black text-blue-500">{eduData?.total?.rate || 0}<small className="text-xs font-medium ml-0.5">%</small></span>
              </div>
            </div>
                  ...
                  <div key={loc} className="gauge-item flex flex-col items-center">
                    <div className="liq-gauge-wrap relative w-28 h-28 flex items-center justify-center">
                      ...
                      <div className="liq-tank-circle absolute w-[88px] h-[88px] rounded-full overflow-hidden bg-white shadow-inner flex items-center justify-center">
                        <div className="liq-val-circle absolute z-10 font-black text-lg text-slate-800">{pct}<span className="liq-pct text-xs">%</span></div>
        ...
        <div className="content-card kpi-dashboard-card border border-slate-200/80 shadow-sm rounded-[20px] bg-white overflow-hidden h-[360px] flex flex-col transition hover:shadow-md">
          <div className="card-header-simple p-3.5 px-4 border-b border-gray-100 flex items-center justify-between shrink-0">
            <div className="flex items-center gap-2.5">
              <div className="icon-box bg-transparent w-auto h-auto p-0 flex items-center justify-center">
                <i className="fa-solid fa-comments text-purple-500 text-lg"></i>
              </div>
          ...
          <div className="home-card-content loaded p-4 flex-1 flex flex-col justify-between" id="home-tbm-content">
            <div className="kpi-mini-row grid grid-cols-4 gap-2 mb-4">
              <div className="kpi-mini-item text-center bg-slate-50 rounded-xl py-2.5">
                <span className="label block text-[11px] font-bold text-slate-500 mb-1">대상</span>
                <span className="value block text-xl font-black text-slate-800">{tbmData?.total?.target || 0}<small className="text-xs font-medium ml-0.5">팀</small></span>
              </div>
              <div className="kpi-mini-item text-center bg-slate-50 rounded-xl py-2.5">
                <span className="label block text-[11px] font-bold text-slate-500 mb-1">완료</span>
                <span className="value block text-xl font-black text-emerald-500">{tbmData?.total?.done || 0}<small className="text-xs font-medium ml-0.5">팀</small></span>
              </div>
              <div className="kpi-mini-item text-center bg-slate-50 rounded-xl py-2.5">
                <span className="label block text-[11px] font-bold text-slate-500 mb-1">미실시</span>
                <span className="value block text-xl font-black text-rose-500">{tbmData?.total?.undone || 0}<small className="text-xs font-medium ml-0.5">팀</small></span>
              </div>
              <div className="kpi-mini-item text-center bg-slate-50 rounded-xl py-2.5">
                <span className="label block text-[11px] font-bold text-slate-500 mb-1">실시율</span>
                <span className="value block text-xl font-black text-purple-500">{tbmData?.total?.rate || 0}<small className="text-xs font-medium ml-0.5">%</small></span>
              </div>
            </div>
        ...
        {/* 3. Legal Status */}
        <div className="content-card kpi-dashboard-card border border-slate-200/80 shadow-sm rounded-[20px] bg-white overflow-hidden flex flex-col h-[360px] transition hover:shadow-md">
          <div className="card-header-simple p-3.5 px-4 border-b border-gray-100 flex items-center gap-2.5 shrink-0">
            <div className="icon-box bg-transparent w-auto h-auto p-0 flex items-center justify-center">
              <i className="fa-solid fa-gavel text-blue-500 text-lg"></i>
            </div>
            <h4 className="font-black text-slate-800 flex-1 m-0 text-[15px] tracking-tight">
          ...
          <div className="home-card-content loaded p-4 flex flex-col flex-1 overflow-hidden" id="home-legal-content">
            <div className="kpi-mini-row grid grid-cols-4 gap-2 mb-3 shrink-0">
              <div className="kpi-mini-item text-center bg-slate-50 rounded-xl py-2.5">
                <span className="label block text-[11px] font-bold text-slate-500 mb-1">대상</span>
                <span className="value block text-xl font-black text-slate-800">{legalData?.total?.target || 0}<small className="text-xs font-medium ml-0.5">명</small></span>
              </div>
              <div className="kpi-mini-item text-center bg-slate-50 rounded-xl py-2.5">
                <span className="label block text-[11px] font-bold text-slate-500 mb-1">이수</span>
                <span className="value block text-xl font-black text-emerald-500">{legalData?.total?.done || 0}<small className="text-xs font-medium ml-0.5">명</small></span>
              </div>
              <div className="kpi-mini-item text-center bg-slate-50 rounded-xl py-2.5">
                <span className="label block text-[11px] font-bold text-slate-500 mb-1">미이수</span>
                <span className="value block text-xl font-black text-rose-500">{legalData?.total?.undone || 0}<small className="text-xs font-medium ml-0.5">명</small></span>
              </div>
              <div className="kpi-mini-item text-center bg-slate-50 rounded-xl py-2.5">
                <span className="label block text-[11px] font-bold text-slate-500 mb-1">이수율</span>
                <span className="value block text-xl font-black text-blue-500">{legalData?.total?.rate || 0}<small className="text-xs font-medium ml-0.5">%</small></span>
              </div>
            </div>
      ...
      <section className="home-grid-bottom mt-5 grid grid-cols-1 lg:grid-cols-3 gap-5">
        ...
        {/* KOSHA News */}
        <div className="content-card list-card border border-slate-200/80 shadow-sm rounded-[20px] bg-white overflow-hidden flex flex-col h-[360px] transition hover:shadow-md">
          <div className="card-header-simple p-3.5 px-4 border-b border-gray-100 flex items-center justify-between shrink-0">
            <div className="flex items-center gap-2.5">
              <div className="icon-box bg-transparent w-auto h-auto p-0 flex items-center justify-center">
        ...
        <div className="content-card list-card border border-slate-200/80 shadow-sm rounded-[20px] bg-white overflow-hidden flex flex-col h-[360px] transition hover:shadow-md">
          <div className="card-header-simple p-3.5 px-4 border-b border-gray-100 flex items-center gap-2.5 shrink-0">
            <div className="icon-box bg-transparent w-auto h-auto p-0 flex items-center justify-center">
              <i className="fa-solid fa-newspaper text-slate-500 text-lg"></i>
            </div>
        ...
        {/* Weather */}
        <div className="content-card weather-card border border-slate-200/80 shadow-sm rounded-[20px] bg-white overflow-hidden flex flex-col h-[360px] transition hover:shadow-md">
          <div className="card-header-simple p-3.5 px-4 border-b border-gray-100 flex items-center justify-between shrink-0">
            <div className="flex items-center gap-2.5">
              <div className="icon-box bg-transparent w-auto h-auto p-0 flex items-center justify-center">
                <i className="fa-solid fa-cloud-sun text-amber-500 text-lg"></i>
              </div>
